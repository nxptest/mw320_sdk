...
* \file cmd_ble.c
*
* This is the source file for the HSDK module
...
{
	HSDK_transmitPayload(arg, 0x42, 0x01, NULL, 0, fsciInterface);
...
memStatus_t L2CAPCBRegisterLePsmRequest(L2CAPCBRegisterLePsmRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	msgLen += sizeof(uint16_t);  /* LePsmMtu */
	...
	FLib_MemCpy(pMsg + idx, &(req->LePsmMtu), sizeof(req->LePsmMtu)); idx += sizeof(req->LePsmMtu);

	/* Send the request */
	HSDK_transmitPayload(arg, 0x42, 0x02, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c; 
}
...
memStatus_t L2CAPCBDeregisterLePsmRequest(L2CAPCBDeregisterLePsmRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x42, 0x03, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t L2CAPCBConnectLePsmRequest(L2CAPCBConnectLePsmRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x42, 0x04, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t L2CAPCBDisconnectLeCbChannelRequest(L2CAPCBDisconnectLeCbChannelRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x42, 0x05, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t L2CAPCBCancelConnectionRequest(L2CAPCBCancelConnectionRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x42, 0x06, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t L2CAPCBSendLeCbDataRequest(L2CAPCBSendLeCbDataRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x42, 0x07, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t L2CAPCBSendLeCreditRequest(L2CAPCBSendLeCreditRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	msgLen += sizeof(uint8_t);  /* DeviceId */
	msgLen += sizeof(uint16_t);  /* ChannelId */
	msgLen += sizeof(uint16_t);  /* Credits */
	...
	pMsg[idx] = req->DeviceId; idx++;
	FLib_MemCpy(pMsg + idx, &(req->ChannelId), sizeof(req->ChannelId)); idx += sizeof(req->ChannelId);
	FLib_MemCpy(pMsg + idx, &(req->Credits), sizeof(req->Credits)); idx += sizeof(req->Credits);

	/* Send the request */
	HSDK_transmitPayload(arg, 0x42, 0x08, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x45, 0x01, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTGetMtuRequest(GATTGetMtuRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x02, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x45, 0x03, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x45, 0x04, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x45, 0x05, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x45, 0x06, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x45, 0x07, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTClientExchangeMtuRequest(GATTClientExchangeMtuRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x08, req, sizeof(GATTClientExchangeMtuRequest_t), fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTClientDiscoverAllPrimaryServicesRequest(GATTClientDiscoverAllPrimaryServicesRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x09, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTClientDiscoverPrimaryServicesByUuidRequest(GATTClientDiscoverPrimaryServicesByUuidRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x0A, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTClientFindIncludedServicesRequest(GATTClientFindIncludedServicesRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x0B, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTClientDiscoverAllCharacteristicsOfServiceRequest(GATTClientDiscoverAllCharacteristicsOfServiceRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x0C, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTClientDiscoverCharacteristicOfServiceByUuidRequest(GATTClientDiscoverCharacteristicOfServiceByUuidRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x0D, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTClientDiscoverAllCharacteristicDescriptorsRequest(GATTClientDiscoverAllCharacteristicDescriptorsRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x0E, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTClientReadCharacteristicValueRequest(GATTClientReadCharacteristicValueRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x0F, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTClientReadUsingCharacteristicUuidRequest(GATTClientReadUsingCharacteristicUuidRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x10, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTClientReadMultipleCharacteristicValuesRequest(GATTClientReadMultipleCharacteristicValuesRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x11, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTClientWriteCharacteristicValueRequest(GATTClientWriteCharacteristicValueRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x12, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTClientReadCharacteristicDescriptorRequest(GATTClientReadCharacteristicDescriptorRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x13, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTClientWriteCharacteristicDescriptorRequest(GATTClientWriteCharacteristicDescriptorRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x14, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x45, 0x15, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x45, 0x16, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTServerRegisterHandlesForWriteNotificationsRequest(GATTServerRegisterHandlesForWriteNotificationsRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x17, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTServerSendAttributeWrittenStatusRequest(GATTServerSendAttributeWrittenStatusRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Serialize */
	pMsg[idx] = req->DeviceId; idx++;
	FLib_MemCpy(pMsg + idx, &(req->AttributeHandle), sizeof(req->AttributeHandle)); idx += sizeof(req->AttributeHandle);
	pMsg[idx] = req->Status; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x18, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTServerSendNotificationRequest(GATTServerSendNotificationRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x19, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTServerSendIndicationRequest(GATTServerSendIndicationRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x1A, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTServerSendInstantValueNotificationRequest(GATTServerSendInstantValueNotificationRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x1B, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTServerSendInstantValueIndicationRequest(GATTServerSendInstantValueIndicationRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x1C, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTServerRegisterHandlesForReadNotificationsRequest(GATTServerRegisterHandlesForReadNotificationsRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x1D, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTServerSendAttributeReadStatusRequest(GATTServerSendAttributeReadStatusRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x1E, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTServerRegisterUniqueHandlesForNotificationsRequest(GATTServerRegisterUniqueHandlesForNotificationsRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Compute the size of the request */
	msgLen += sizeof(bool_t);  /* bWrite */
	msgLen += sizeof(bool_t);  /* bRead */
	...
	/* Serialize */
	pMsg[idx] = req->bWrite; idx++;
	pMsg[idx] = req->bRead; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x1F, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTServerUnregisterHandlesForWriteNotificationsRequest(GATTServerUnregisterHandlesForWriteNotificationsRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x20, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTServerUnregisterHandlesForReadNotificationsRequest(GATTServerUnregisterHandlesForReadNotificationsRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x45, 0x21, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTDBWriteAttributeRequest(GATTDBWriteAttributeRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x46, 0x02, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTDBReadAttributeRequest(GATTDBReadAttributeRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Compute the size of the request */
	msgLen += sizeof(uint16_t);  /* Handle */
	msgLen += sizeof(uint16_t);  /* MaxBytes */
	...
	/* Serialize */
	FLib_MemCpy(pMsg + idx, &(req->Handle), sizeof(req->Handle)); idx += sizeof(req->Handle);
	FLib_MemCpy(pMsg + idx, &(req->MaxBytes), sizeof(req->MaxBytes)); idx += sizeof(req->MaxBytes);

	/* Send the request */
	HSDK_transmitPayload(arg, 0x46, 0x03, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTDBFindServiceHandleRequest(GATTDBFindServiceHandleRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x46, 0x04, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTDBFindCharValueHandleInServiceRequest(GATTDBFindCharValueHandleInServiceRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x46, 0x05, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTDBFindCccdHandleForCharValueHandleRequest(GATTDBFindCccdHandleForCharValueHandleRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x46, 0x06, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTDBFindDescriptorHandleForCharValueHandleRequest(GATTDBFindDescriptorHandleForCharValueHandleRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x46, 0x07, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x46, 0x08, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x46, 0x09, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTDBDynamicAddPrimaryServiceDeclarationRequest(GATTDBDynamicAddPrimaryServiceDeclarationRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x46, 0x0A, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTDBDynamicAddSecondaryServiceDeclarationRequest(GATTDBDynamicAddSecondaryServiceDeclarationRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x46, 0x0B, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTDBDynamicAddIncludeDeclarationRequest(GATTDBDynamicAddIncludeDeclarationRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x46, 0x0C, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTDBDynamicAddCharacteristicDeclarationAndValueRequest(GATTDBDynamicAddCharacteristicDeclarationAndValueRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x46, 0x0D, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTDBDynamicAddCharacteristicDescriptorRequest(GATTDBDynamicAddCharacteristicDescriptorRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x46, 0x0E, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x46, 0x0F, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTDBDynamicAddCharacteristicDeclarationWithUniqueValueRequest(GATTDBDynamicAddCharacteristicDeclarationWithUniqueValueRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x46, 0x10, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTDBDynamicRemoveServiceRequest(GATTDBDynamicRemoveServiceRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x46, 0x11, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTDBDynamicRemoveCharacteristicRequest(GATTDBDynamicRemoveCharacteristicRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Compute the size of the request */
	msgLen += sizeof(uint16_t);  /* CharacteristicHandle */
	...
	/* Serialize */
	FLib_MemCpy(pMsg + idx, &(req->CharacteristicHandle), sizeof(req->CharacteristicHandle)); idx += sizeof(req->CharacteristicHandle);

	/* Send the request */
	HSDK_transmitPayload(arg, 0x46, 0x12, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GATTDBDynamicAddCharDescriptorWithUniqueValueRequest(GATTDBDynamicAddCharDescriptorWithUniqueValueRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x46, 0x13, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x48, 0x01, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPRegisterDeviceSecurityRequirementsRequest(GAPRegisterDeviceSecurityRequirementsRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x02, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPSetAdvertisingParametersRequest(GAPSetAdvertisingParametersRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Compute the size of the request */
	msgLen += sizeof(uint16_t);  /* MinInterval */
	msgLen += sizeof(uint16_t);  /* MaxInterval */
	msgLen += sizeof(uint8_t);  /* AdvertisingType */
	msgLen += sizeof(uint8_t);  /* OwnAddressType */
	msgLen += sizeof(uint8_t);  /* PeerAddressType */
	msgLen += 6;  /* PeerAddress */
	msgLen += 1;  /* 0x04|0x02|0x01 */  /* ChannelMap */
	...
	/* Serialize */
	FLib_MemCpy(pMsg + idx, &(req->MinInterval), sizeof(req->MinInterval)); idx += sizeof(req->MinInterval);
	FLib_MemCpy(pMsg + idx, &(req->MaxInterval), sizeof(req->MaxInterval)); idx += sizeof(req->MaxInterval);
	pMsg[idx] = req->AdvertisingType; idx++;
	pMsg[idx] = req->OwnAddressType; idx++;
	pMsg[idx] = req->PeerAddressType; idx++;
	FLib_MemCpy(pMsg + idx, req->PeerAddress, 6); idx += 6;
	pMsg[idx] = req->ChannelMap; idx++;
	pMsg[idx] = req->FilterPolicy; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x03, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPSetAdvertisingDataRequest(GAPSetAdvertisingDataRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x04, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x48, 0x05, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x48, 0x06, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPAuthorizeRequest(GAPAuthorizeRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	pMsg[idx] = req->DeviceId; idx++;
	FLib_MemCpy(pMsg + idx, &(req->Handle), sizeof(req->Handle)); idx += sizeof(req->Handle);
	pMsg[idx] = req->Access; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x07, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPSaveCccdRequest(GAPSaveCccdRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	pMsg[idx] = req->DeviceId; idx++;
	FLib_MemCpy(pMsg + idx, &(req->Handle), sizeof(req->Handle)); idx += sizeof(req->Handle);
	pMsg[idx] = req->Cccd; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x08, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPCheckNotificationStatusRequest(GAPCheckNotificationStatusRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x09, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPCheckIndicationStatusRequest(GAPCheckIndicationStatusRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x0A, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPPairRequest(GAPPairRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x0C, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c; 
}
...
memStatus_t GAPSendSlaveSecurityRequestRequest(GAPSendSlaveSecurityRequestRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x0D, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPEncryptLinkRequest(GAPEncryptLinkRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x0E, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPAcceptPairingRequestRequest(GAPAcceptPairingRequestRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x0F, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPRejectPairingRequest(GAPRejectPairingRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Serialize */
	pMsg[idx] = req->DeviceId; idx++;
	pMsg[idx] = req->Reason; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x10, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPEnterPasskeyRequest(GAPEnterPasskeyRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Serialize */
	pMsg[idx] = req->DeviceId; idx++;
	FLib_MemCpy(pMsg + idx, &(req->Passkey), sizeof(req->Passkey)); idx += sizeof(req->Passkey);

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x11, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPProvideOobRequest(GAPProvideOobRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Serialize */
	pMsg[idx] = req->DeviceId; idx++;
	FLib_MemCpy(pMsg + idx, req->Oob, 16); idx += 16;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x12, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPRejectPasskeyRequestRequest(GAPRejectPasskeyRequestRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x13, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPSendSmpKeysRequest(GAPSendSmpKeysRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x14, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPRejectKeyExchangeRequestRequest(GAPRejectKeyExchangeRequestRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x15, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPProvideLongTermKeyRequest(GAPProvideLongTermKeyRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x16, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPDenyLongTermKeyRequest(GAPDenyLongTermKeyRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x17, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPLoadEncryptionInformationRequest(GAPLoadEncryptionInformationRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x18, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPSetLocalPasskeyRequest(GAPSetLocalPasskeyRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x19, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPStartScanningRequest(GAPStartScanningRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x1A, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x48, 0x1B, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPConnectRequest(GAPConnectRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Serialize */
	FLib_MemCpy(pMsg + idx, &(req->ScanInterval), sizeof(req->ScanInterval)); idx += sizeof(req->ScanInterval);
	FLib_MemCpy(pMsg + idx, &(req->ScanWindow), sizeof(req->ScanWindow)); idx += sizeof(req->ScanWindow);
	pMsg[idx] = req->FilterPolicy; idx++;
	pMsg[idx] = req->OwnAddressType; idx++;
	pMsg[idx] = req->PeerAddressType; idx++;
	FLib_MemCpy(pMsg + idx, req->PeerAddress, 6); idx += 6;
	FLib_MemCpy(pMsg + idx, &(req->ConnIntervalMin), sizeof(req->ConnIntervalMin)); idx += sizeof(req->ConnIntervalMin);
	FLib_MemCpy(pMsg + idx, &(req->ConnIntervalMax), sizeof(req->ConnIntervalMax)); idx += sizeof(req->ConnIntervalMax);
	FLib_MemCpy(pMsg + idx, &(req->ConnLatency), sizeof(req->ConnLatency)); idx += sizeof(req->ConnLatency);
	FLib_MemCpy(pMsg + idx, &(req->SupervisionTimeout), sizeof(req->SupervisionTimeout)); idx += sizeof(req->SupervisionTimeout);
	FLib_MemCpy(pMsg + idx, &(req->ConnEventLengthMin), sizeof(req->ConnEventLengthMin)); idx += sizeof(req->ConnEventLengthMin);
	FLib_MemCpy(pMsg + idx, &(req->ConnEventLengthMax), sizeof(req->ConnEventLengthMax)); idx += sizeof(req->ConnEventLengthMax);
	pMsg[idx] = req->usePeerIdentityAddress; idx++;
	pMsg[idx] = req->Initiating_PHYs; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x1C, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPDisconnectRequest(GAPDisconnectRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x1D, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPSaveCustomPeerInformationRequest(GAPSaveCustomPeerInformationRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x1E, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPLoadCustomPeerInformationRequest(GAPLoadCustomPeerInformationRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x1F, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPCheckIfBondedRequest(GAPCheckIfBondedRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x20, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x48, 0x21, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x48, 0x22, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPAddDeviceToWhiteListRequest(GAPAddDeviceToWhiteListRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	FLib_MemCpy(pMsg + idx, req->Address, 6); idx += 6;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x23, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPRemoveDeviceFromWhiteListRequest(GAPRemoveDeviceFromWhiteListRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x24, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x48, 0x25, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPCreateRandomDeviceAddressRequest(GAPCreateRandomDeviceAddressRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x26, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPSaveDeviceNameRequest(GAPSaveDeviceNameRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x27, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x48, 0x28, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPGetBondedDeviceNameRequest(GAPGetBondedDeviceNameRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	msgLen += sizeof(uint8_t);  /* MaxNameSize */
	...
	pMsg[idx] = req->MaxNameSize; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x29, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPRemoveBondRequest(GAPRemoveBondRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x2A, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x48, 0x2B, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPReadRadioPowerLevelRequest(GAPReadRadioPowerLevelRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Compute the size of the request */
	msgLen += sizeof(uint8_t);  /* TxReadType */
	msgLen += sizeof(uint8_t);  /* DeviceId */
	...
	/* Serialize */
	pMsg[idx] = req->TxReadType; idx++;
	pMsg[idx] = req->DeviceId; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x2C, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPVerifyPrivateResolvableAddressRequest(GAPVerifyPrivateResolvableAddressRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x2D, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPSetRandomAddressRequest(GAPSetRandomAddressRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x2E, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPSetScanModeRequest(GAPSetScanModeRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x2F, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPSetDefaultPairingParametersRequest(GAPSetDefaultPairingParametersRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x30, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPUpdateConnectionParametersRequest(GAPUpdateConnectionParametersRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Compute the size of the request */
	msgLen += sizeof(uint8_t);   /* DeviceId */
	msgLen += sizeof(uint16_t);  /* IntervalMin */
	msgLen += sizeof(uint16_t);  /* IntervalMax */
	msgLen += sizeof(uint16_t);  /* SlaveLatency */
	msgLen += sizeof(uint16_t);  /* TimeoutMultiplier */
	msgLen += sizeof(uint16_t);  /* MinCeLength */
	msgLen += sizeof(uint16_t);  /* MaxCeLength */
	...
	/* Serialize */
	pMsg[idx] = req->DeviceId; idx++;
	FLib_MemCpy(pMsg + idx, &(req->IntervalMin), sizeof(req->IntervalMin)); idx += sizeof(req->IntervalMin);
	FLib_MemCpy(pMsg + idx, &(req->IntervalMax), sizeof(req->IntervalMax)); idx += sizeof(req->IntervalMax);
	FLib_MemCpy(pMsg + idx, &(req->SlaveLatency), sizeof(req->SlaveLatency)); idx += sizeof(req->SlaveLatency);
	FLib_MemCpy(pMsg + idx, &(req->TimeoutMultiplier), sizeof(req->TimeoutMultiplier)); idx += sizeof(req->TimeoutMultiplier);
	FLib_MemCpy(pMsg + idx, &(req->MinCeLength), sizeof(req->MinCeLength)); idx += sizeof(req->MinCeLength);
	FLib_MemCpy(pMsg + idx, &(req->MaxCeLength), sizeof(req->MaxCeLength)); idx += sizeof(req->MaxCeLength);

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x31, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c; 
}
...
memStatus_t GAPEnableUpdateConnectionParametersRequest(GAPEnableUpdateConnectionParametersRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x32, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GapUpdateLeDataLengthRequest(GapUpdateLeDataLengthRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Compute the size of the request */
	msgLen += sizeof(uint8_t);  /* DeviceId */
	msgLen += sizeof(uint16_t);  /* TxOctets */
	msgLen += sizeof(uint16_t);  /* TxTime */
	...
	/* Serialize */
	pMsg[idx] = req->DeviceId; idx++;
	FLib_MemCpy(pMsg + idx, &(req->TxOctets), sizeof(req->TxOctets)); idx += sizeof(req->TxOctets);
	FLib_MemCpy(pMsg + idx, &(req->TxTime), sizeof(req->TxTime)); idx += sizeof(req->TxTime);

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x33, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPEnableHostPrivacyRequest(GAPEnableHostPrivacyRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x35, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPEnableControllerPrivacyRequest(GAPEnableControllerPrivacyRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x36, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x48, 0x37, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPLeScValidateNumericValueRequest(GAPLeScValidateNumericValueRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Serialize */
	pMsg[idx] = req->DeviceId; idx++;
	pMsg[idx] = req->Valid; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x38, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0x48, 0x39, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPLeScSetPeerOobDataRequest(GAPLeScSetPeerOobDataRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Compute the size of the request */
	msgLen += sizeof(uint8_t);  /* DeviceId */
	msgLen += 16;  /* RandomValue */
	msgLen += 16;  /* ConfirmValue */
	...
	/* Serialize */
	pMsg[idx] = req->DeviceId; idx++;
	FLib_MemCpy(pMsg + idx, req->RandomValue, 16); idx += 16;
	FLib_MemCpy(pMsg + idx, req->ConfirmValue, 16); idx += 16;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x3A, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPLeScSendKeypressNotificationPrivacyRequest(GAPLeScSendKeypressNotificationPrivacyRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Compute the size of the request */
	msgLen += sizeof(uint8_t);  /* DeviceId */
	msgLen += sizeof(uint8_t);  /* GapLeScKeypressNotificationParams_keypressNotifType */
	...
	/* Serialize */
	pMsg[idx] = req->DeviceId; idx++;
	pMsg[idx] = req->GapLeScKeypressNotificationParams_keypressNotifType; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x3B, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPGetBondedDevicesIdentityInformationRequest(GAPGetBondedDevicesIdentityInformationRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Compute the size of the request */
	msgLen += sizeof(uint8_t);  /* maxDevices */
	...
	/* Serialize */
	pMsg[idx] = req->maxDevices; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x3C, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPSetTxPowerLevelRequest(GAPSetTxPowerLevelRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Compute the size of the request */
	msgLen += sizeof(uint8_t);  /* powerLevel */
	msgLen += sizeof(uint8_t);  /* channelType */
	...
	/* Serialize */
	pMsg[idx] = req->powerLevel; idx++;
	pMsg[idx] = req->channelType; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x3D, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPLeReadPhyRequest(GAPLeReadPhyRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x3E, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPLeSetPhyRequest(GAPLeSetPhyRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Compute the size of the request */
	msgLen += sizeof(bool_t);  /* defaultMode */
	msgLen += sizeof(uint8_t);  /* DeviceId */
	msgLen += 1;  /* 0x02|0x01 */  /* allPhys */
	msgLen += 1;  /* 0x04|0x02|0x01 */  /* txPhys */
	msgLen += 1;  /* 0x04|0x02|0x01 */  /* rxPhys */
	msgLen += sizeof(uint16_t);  /* phyOptions */
	...
	/* Serialize */
	pMsg[idx] = req->defaultMode; idx++;
	pMsg[idx] = req->DeviceId; idx++;
	pMsg[idx] = req->allPhys; idx++;
	pMsg[idx] = req->txPhys; idx++;
	pMsg[idx] = req->rxPhys; idx++;
	FLib_MemCpy(pMsg + idx, &req->phyOptions, sizeof(uint16_t)); idx += sizeof(uint16_t);

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x3F, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPControllerEnhancedNotificationRequest(GAPControllerEnhancedNotificationRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Compute the size of the request */
	msgLen += 2;  /* 0x0400|0x0200|0x0100|0x80|0x40|0x20|0x10|0x08|0x04|0x02|0x01 */  /* EventType */
	msgLen += sizeof(uint8_t);  /* DeviceId */
	...
	/* Serialize */
	FLib_MemCpy(pMsg + idx, &(req->EventType), 2); idx += 2;
	pMsg[idx] = req->DeviceId; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x40, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPLoadKeysRequest(GAPLoadKeysRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x41, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPSaveKeysRequest(GAPSaveKeysRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x42, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPSetChannelMapRequest(GAPSetChannelMapRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Serialize */
	FLib_MemCpy(pMsg + idx, req->ChannelMap, 5); idx += 5;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x43, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPReadChannelMapRequest(GAPReadChannelMapRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x44, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPSetPrivacyModeRequest(GAPSetPrivacyModeRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Serialize */
	pMsg[idx] = req->NvmIndex; idx++;
	pMsg[idx] = req->PrivacyMode; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x45, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t ControllerSetScanDupFiltModeRequest(ControllerSetScanDupFiltModeRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x46, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
        return MEM_SUCCESS_c;
}
...
memStatus_t WritePublicDeviceAddressRequest(WritePublicDeviceAddressRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Compute the size of the request */
	msgLen += sizeof(bool_t);  /* CPUReset */
	msgLen += 6;  /* BluetoothAddress */
	...
	/* Serialize */
	pMsg[idx] = req->CPUReset; idx++;
	FLib_MemCpy(pMsg + idx, req->BluetoothAddress, 6); idx += 6;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x48, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPSetExtAdvertisingParametersRequest(GAPSetExtAdvertisingParametersRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	msgLen += sizeof(uint32_t);  /* MinInterval */
	msgLen += sizeof(uint32_t);  /* MaxInterval */
	msgLen += sizeof(uint8_t);  /* OwnAddressType */
	msgLen += 6;  /* OwnRandomAddress */
	msgLen += sizeof(uint8_t);  /* PeerAddressType */
	msgLen += 6;  /* PeerAddress */
	msgLen += 1;  /* 0x04|0x02|0x01 */  /* ChannelMap */
	msgLen += sizeof(uint8_t);  /* FilterPolicy */
	msgLen += 2;  /* Reserved|gExtAdvIncludeTxPower_c|gExtAdvAnonymous_c|gExtAdvLegacy_c|gExtAdvFastDirected_c|gExtAdvDirected_c|gExtAdvScannable_c|gExtAdvConnectable_c */  /* AdvProperties */
	msgLen += sizeof(uint8_t);  /* AdvTxPowerLevel */
	msgLen += sizeof(uint8_t);  /* PrimaryAdvPHY */
	msgLen += sizeof(uint8_t);  /* SecondaryAdvPHY */
	msgLen += sizeof(uint8_t);  /* SecondaryAdvMaxSkip */
	msgLen += sizeof(bool_t);  /* EnableScanReqNotification */
	...
	/* Serialize */
	pMsg[idx] = req->SID; idx++;
	pMsg[idx] = req->Handle; idx++;
	FLib_MemCpy(pMsg + idx, &(req->MinInterval), sizeof(req->MinInterval)); idx += sizeof(req->MinInterval);
	FLib_MemCpy(pMsg + idx, &(req->MaxInterval), sizeof(req->MaxInterval)); idx += sizeof(req->MaxInterval);
	pMsg[idx] = req->OwnAddressType; idx++;
	FLib_MemCpy(pMsg + idx, req->OwnRandomAddress, 6); idx += 6;
	pMsg[idx] = req->PeerAddressType; idx++;
	FLib_MemCpy(pMsg + idx, req->PeerAddress, 6); idx += 6;
	pMsg[idx] = req->ChannelMap; idx++;
	pMsg[idx] = req->FilterPolicy; idx++;
	FLib_MemCpy(pMsg + idx, &(req->AdvProperties), 2); idx += 2;
	pMsg[idx] = req->AdvTxPowerLevel; idx++;
	pMsg[idx] = req->PrimaryAdvPHY; idx++;
	pMsg[idx] = req->SecondaryAdvPHY; idx++;
	pMsg[idx] = req->SecondaryAdvMaxSkip; idx++;
	pMsg[idx] = req->EnableScanReqNotification; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x50, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPStartExtAdvertisingRequest(GAPStartExtAdvertisingRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	msgLen += sizeof(uint8_t);  /* Handle */
	msgLen += sizeof(uint16_t);  /* Duration */
	msgLen += sizeof(uint8_t);  /* MaxExtAdvEvents */
	...
	pMsg[idx] = req->Handle; idx++;
	FLib_MemCpy(pMsg + idx, &(req->Duration), sizeof(req->Duration)); idx += sizeof(req->Duration);
	pMsg[idx] = req->MaxExtAdvEvents; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x51, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPRemoveAdvertisingSetRequest(GAPRemoveAdvertisingSetRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x52, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPStopExtAdvertisingRequest(GAPStopExtAdvertisingRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x53, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPUpdatePeriodicAdvListRequest(GAPUpdatePeriodicAdvListRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x54, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPSetPeriodicAdvParametersRequest(GAPSetPeriodicAdvParametersRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Compute the size of the request */
	msgLen += sizeof(uint8_t);  /* Handle */
	msgLen += sizeof(bool_t);  /* IncludeTxPower */
	msgLen += sizeof(uint16_t);  /* MinInterval */
	msgLen += sizeof(uint16_t);  /* MaxInterval */
	...
	/* Serialize */
	pMsg[idx] = req->Handle; idx++;
	pMsg[idx] = req->IncludeTxPower; idx++;
	FLib_MemCpy(pMsg + idx, &(req->MinInterval), sizeof(req->MinInterval)); idx += sizeof(req->MinInterval);
	FLib_MemCpy(pMsg + idx, &(req->MaxInterval), sizeof(req->MaxInterval)); idx += sizeof(req->MaxInterval);

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x55, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPStartPeriodicAdvertisingRequest(GAPStartPeriodicAdvertisingRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x56, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPStopPeriodicAdvertisingRequest(GAPStopPeriodicAdvertisingRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x57, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPSetExtAdvertisingDataRequest(GAPSetExtAdvertisingDataRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	if (req->AdvertisingDataIncluded)
	{
            ...
            for (uint32_t i = 0; i < req->ExtAdvertisingData.NbOfAdStructures; i++)
            {
                    msgLen += sizeof(uint8_t);  /* Length */
                    msgLen += sizeof(uint8_t);  /* Type */
                    msgLen += req->ExtAdvertisingData.AdStructures[i].Length;  /* Data */
            }		/* AdStructures */
	}	/* ExtAdvertisingData */
	...
	if (req->ScanResponseDataIncluded)
	{
            ...
            for (uint32_t i = 0; i < req->ExtScanResponseData.NbOfAdStructures; i++)
            {
                    msgLen += sizeof(uint8_t);  /* Length */
                    msgLen += sizeof(uint8_t);  /* Type */
                    msgLen += req->ExtScanResponseData.AdStructures[i].Length;  /* Data */
            }		/* AdStructures */
	}	/* ExtScanResponseData */
	...
	if (req->AdvertisingDataIncluded)
	{
            pMsg[idx] = req->ExtAdvertisingData.NbOfAdStructures; idx++;

            for (uint32_t i = 0; i < req->ExtAdvertisingData.NbOfAdStructures; i++)
            {
                    pMsg[idx] = req->ExtAdvertisingData.AdStructures[i].Length; idx++;
                    pMsg[idx] = req->ExtAdvertisingData.AdStructures[i].Type; idx++;
                    FLib_MemCpy(pMsg + idx, req->ExtAdvertisingData.AdStructures[i].Data, req->ExtAdvertisingData.AdStructures[i].Length); idx += req->ExtAdvertisingData.AdStructures[i].Length;
            }
	}
	pMsg[idx] = req->ScanResponseDataIncluded; idx++;
	...
	if (req->ScanResponseDataIncluded)
	{
            pMsg[idx] = req->ExtScanResponseData.NbOfAdStructures; idx++;

            for (uint32_t i = 0; i < req->ExtScanResponseData.NbOfAdStructures; i++)
            {
                    pMsg[idx] = req->ExtScanResponseData.AdStructures[i].Length; idx++;
                    pMsg[idx] = req->ExtScanResponseData.AdStructures[i].Type; idx++;
                    FLib_MemCpy(pMsg + idx, req->ExtScanResponseData.AdStructures[i].Data, req->ExtScanResponseData.AdStructures[i].Length); idx += req->ExtScanResponseData.AdStructures[i].Length;
            }
	}

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x58, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPSetPeriodicAdvertisingDataRequest(GAPSetPeriodicAdvertisingDataRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x59, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPPeriodicAdvCreateSyncRequest(GAPPeriodicAdvCreateSyncRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	msgLen += sizeof(uint8_t);  /* DeviceAddressType */
	msgLen += 6;  /* DeviceAddress */
	msgLen += sizeof(uint16_t);  /* SkipCount */
	msgLen += sizeof(uint16_t);  /* Timeout */
	...
	pMsg[idx] = req->FilterPolicy; idx++;
	pMsg[idx] = req->SID; idx++;
	pMsg[idx] = req->DeviceAddressType; idx++;
	FLib_MemCpy(pMsg + idx, req->DeviceAddress, 6); idx += 6;
	FLib_MemCpy(pMsg + idx, &(req->SkipCount), sizeof(req->SkipCount)); idx += sizeof(req->SkipCount);
	FLib_MemCpy(pMsg + idx, &(req->Timeout), sizeof(req->Timeout)); idx += sizeof(req->Timeout);

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x5A, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t GAPPeriodicAdvTerminateSyncRequest(GAPPeriodicAdvTerminateSyncRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x5B, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
memStatus_t ControllerConfigureAdvCodingSchemeRequest(ControllerConfigureAdvCodingSchemeRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Compute the size of the request */
	msgLen += sizeof(uint8_t);  /* CodingScheme */
	...
	/* Serialize */
	pMsg[idx] = req->CodingScheme; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0x48, 0x5C, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0xA3, 0x08, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0xA3, 0x09, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
...
memStatus_t FSCIAllowDeviceToSleepRequest(FSCIAllowDeviceToSleepRequest_t *req, void *arg, uint8_t fsciInterface)
{
	...
	/* Compute the size of the request */
	msgLen += sizeof(uint8_t);  /* SignalHostWhenWakeUp */
	msgLen += sizeof(uint32_t);  /* DeepSleepDuration */
	msgLen += sizeof(uint8_t);  /* DeepSleepMode */
	...
	/* Serialize */
	pMsg[idx] = req->SignalHostWhenWakeUp; idx++;
	FLib_MemCpy(pMsg + idx, &(req->DeepSleepDuration), sizeof(req->DeepSleepDuration)); idx += sizeof(req->DeepSleepDuration);
	pMsg[idx] = req->DeepSleepMode; idx++;

	/* Send the request */
	HSDK_transmitPayload(arg, 0xA3, 0x70, pMsg, msgLen, fsciInterface);
	MEM_BufferFree(pMsg);
	return MEM_SUCCESS_c;
}
...
{
	HSDK_transmitPayload(arg, 0xA3, 0x72, NULL, 0, fsciInterface);
	return MEM_SUCCESS_c;
}
