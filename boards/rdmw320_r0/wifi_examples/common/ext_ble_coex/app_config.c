...
const uint8_t gaGattDbDynamic_W_UartServiceUUID[16] = {0xE0, 0x1C, 0x4B, 0x5E, 0x1E, 0xEB, 0xA1, 0x5C, 0xEE, 0xF4, 0x5E, 0xBA, 0x00, 0x01, 0xFF, 0x01};
const uint8_t gaGattDbDynamic_W_UartStream[16] = { 0xE0, 0x1C, 0x4B, 0x5E, 0x1E, 0xEB, 0xA1, 0x5C, 0xEE, 0xF4, 0x5E, 0xBA, 0x01, 0x01, 0xFF, 0x1};
...
static gapAdStructure_t advScanStruct[3] = {
  ...
  },
  {
    ...
    .aData = (uint8_t *)gaGattDbDynamic_W_UartServiceUUID
  },
  {
