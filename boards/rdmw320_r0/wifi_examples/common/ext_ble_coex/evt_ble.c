...
static memStatus_t Load_GAPAdvertisingEventPeriodicAdvertisingStateChangedIndication(bleEvtContainer_t *container, uint8_t *pPayload);
...
static const bleEvtHandler_t evtHandlerTbl[] =
{
	...
	{GAPAdvertisingEventPeriodicAdvertisingStateChangedIndication_FSCI_ID, Load_GAPAdvertisingEventPeriodicAdvertisingStateChangedIndication},
...
/*!*************************************************************************************************
\fn		static memStatus_t Load_GAPAdvertisingEventPeriodicAdvertisingStateChangedIndication(bleEvtContainer_t *container, uint8_t *pPayload)
\brief	Controller event - Periodic advertising state changed indication
***************************************************************************************************/
static memStatus_t Load_GAPAdvertisingEventPeriodicAdvertisingStateChangedIndication(bleEvtContainer_t *container, uint8_t *pPayload)
{
	GAPAdvertisingEventPeriodicAdvertisingStateChangedIndication_t *evt = &(container->Data.GAPAdvertisingEventPeriodicAdvertisingStateChangedIndication);

	/* Store (OG, OC) in ID */
	container->id = GAPAdvertisingEventPeriodicAdvertisingStateChangedIndication_FSCI_ID;

	FLib_MemCpy(evt, pPayload, sizeof(GAPAdvertisingEventPeriodicAdvertisingStateChangedIndication_t));
...
void KHC_BLE_RX_MsgHandler(void *pData, void *param, uint8_t fsciInterface)
{
	...
	uint8_t og = pClientPacket->structured.header.opGroup;
	uint8_t oc = pClientPacket->structured.header.opCode;
	uint8_t *pPayload = &pClientPacket->structured.payload[0];
