...
********************************************************************************** */
#if !defined(__FRM_OS_ABSTRACTION_FREERTOS_H__)
#define __FRM_OS_ABSTRACTION_FREERTOS_H__
 ...
 */
#define PRIORITY_FRM_OSA_TO_RTOS(osa_prio)  (configMAX_PRIORITIES - (osa_prio) -2)
#define PRIORITY_RTOS_TO_FRM_OSA(rtos_prio) (configMAX_PRIORITIES - (rtos_prio) -2)    
...
#endif // __FRM_OS_ABSTRACTION_FREERTOS_H__
/*******************************************************************************
 * EOF
 ******************************************************************************/
