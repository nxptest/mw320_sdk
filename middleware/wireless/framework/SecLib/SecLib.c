...
#define AES_BLOCK_SIZE     16 /* [bytes] */
    ...
    #define SECLIB_MUTEX_LOCK()   FRM_OSA_MutexLock(mSecLibMutexId, osaWaitForever_c)
    #define SECLIB_MUTEX_UNLOCK() FRM_OSA_MutexUnlock(mSecLibMutexId)
#else
...
void SecLib_Init(void)
{
    ...
    {
        mSecLibMutexId = FRM_OSA_MutexCreate();
        if (mSecLibMutexId == NULL)
        {
 ...
 *
 ****************************************************************************/
#ifndef FSL_FEATURE_SOC_MW_AES_COUNT
