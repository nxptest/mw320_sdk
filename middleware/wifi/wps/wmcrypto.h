 ...
 *  @return                 0 on success, -1 on failure
 */
int mrvl_aes_wrap(uint8_t *plain_txt, uint32_t txt_len, uint8_t *cip_txt, uint8_t *kek, uint32_t kek_len, uint8_t *iv);
 ...
 */
int mrvl_aes_unwrap(
    uint8_t *cip_txt, uint32_t txt_len, uint8_t *plain_txt, uint8_t *kek, uint32_t kek_len, uint8_t *iv);
 ...
 *  @return                 None
 */
void mrvl_crypto_hmac_md5(uint8_t *input, int len, uint8_t *hash, char *hash_key);
